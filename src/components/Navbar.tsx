...
const Navbar = async () => {
   ...
   return(
    <nav className="sticky z-[100] top-0 h-14 inset-x-0 w-full border-b
    border-gray-200 bg-white/75 backdrop-blur-lg transition-all">
       <MaxWidthwrapper>
           <div className="flex h-14 items-center justify-between border-b border-zinc-200">
               ...
               <div className="h-full flex items-center spcae-x-4">
                {
                    user ? (
                        <>
                           ...
                           {isAdmin ? <Link href='/dashboard' className=
                            {buttonVariants({size : 'sm', variant : 'ghost'})}>
                                Dashboard
                            </Link> : null}
                        ...
                        <div className="h-8 w-px bg-zinc-200 hidden sm:block mr-3"/>
                        <Link href='/configure/upload' className=
                            {buttonVariants({size : 'sm', className : 'hidden sm:flex items-center gap-1'})}>
                                Create Case
                                <ArrowRight className="ml-1.5 h-5 w-5"/>
