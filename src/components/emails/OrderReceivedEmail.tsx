...
const OrderReceivedEmail = ({
    ...
    const baseUrl = process.env.NODE_ENV === "development" ? "http://localhost:3000" : "casecobra-dev-three.vercel.app"
    return(
        <Html>
        <Head/>
        ...
        <Body style = {main}>
            <Container style = {container}>
                <Section style={message}>
                    ...
                    We're preparing your order and will notify once your order is shipped. 
                    Delivery usually takes 2 days.
                    </Text>
                    <Text style={{...global.text, marginTop: '24px'}}>
                    If you have any questions, please feel free to contact us with your order number 
