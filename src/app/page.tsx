    ...
    <div className="bg-slate-50 ">
        ...
        lg:pt-24 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              text-grey 900 text-5xl  md:text-6xl lg:text-7xl">
              ...
              text-balance md:text-wrap">Capture your favorite moments with your own, <span className="font-semibold">
                one-of-one</span> phone case. CaseCobra allows you to protect your memories, not just your phone case</p>
          ...
          px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit ">
            <div className="relative md:max-w-xl">
              <img src="/your-image.png" alt="your image" className="absolute w-40 lg:w-52 left-52 -top-20 select-none hidden sm:block lg:hidden xl:block
              "/>
      ...
      <section className="bg-slate-100 py-24">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
          <h2 className="order-1 mt-2 tracking-tight text-center text-
          balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900">What our <span className="relative px-2 ">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16 items-center">
          ...
          <div className="text-lg leading-8 ">
            ...
            <p>
              "I have been using Case Cobra for a long time and it has been a game changer. <span className="p-0.5 bg-slate-800 text-white">I am very satisfied</span> with it.
              I would recommend it to anyone who needs a reliable mobile phone case."
            </p>
          </div>
          <div className="flex gap-4 mt-2">
              ...
              src="/users/user-1.png" alt="user image"/>
               <div>
              <p className="text-sm font-semibold">Jonathon</p>
              <div className="flex gap-1 items-center"><Check className="h-4 w-4 stroke-[3px] text-green-600"/>
          ...
          <div className="text-lg leading-8 ">
            ...
            <p>
              "The case feels durable and I even got a compliment on the durability 
              of the phone. <span className="p-0.5 bg-slate-800 text-white">I would highly recommend</span> this case to anyone who needs it."
            </p>
          </div>
          <div className="flex gap-4 mt-2">
              <img className="rounded-full h-12 w-12 object-cover"
        ...
        <MaxWidthwrapper className="py-24 ">
          <div className="mb-12 px-6 lg:px-8">
              <div className="mx-auto max-w-2xl sm:text-center">
                <h2 className="order-1 mt-2 tracking-tight text-center text-
                balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900">Upload your photo and get <span className="relative px-2 bg-green-600 text-white ">
            ...
            <div className="mx-auto max-w-6xl px-6 lg:px-8">
              <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
                ...
                {/* these help to center the image in center vertically and horizontally */}
                ...
                ring-gray-900/10 lg:rounded-2xl">
                    <img src="/horse.jpg" alt="horse" className="rounded-md object-cover bg-white shadow-2xl ring-1 ring-gray-900/10
                    h-full w-full"/>
                </div>
            ...
            <ul className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
              ...
              <div className="flex justify-center">
                <Link href="/configure/upload" className={
                  buttonVariants({className : 'w-fit mx-auto mt-8', size : 'lg'})
                }>
