...
const DesignConfigurator = ({configId, imageUrl, imageDimensions}: DesignConfiguratorProps) => {
    ...
    return <div className="relative mt-20 mb-20 grid pb-20 grid-cols-3">
        <div className="relative h-[37.5rem] overflow-hidden cols-span-2 w-full max-w-4xl 
        flex items-center justify-center rounded-lg border-2 border-dashed border-gray-300 p-12 text-center focus:outline-none
        foucs:ring-2 focus:ring-primary focus:ring-offset-2">
            <div className="relative w-60 bg-opacity-50 pointer-events-none aspect-[896/1831]">
                <AspectRatio ratio={896/1831} className="pointer-events-none relative z-50 aspect-[896/1831] w-full">
                    <NextImage fill alt="phone" src={"/phone-template.png"} 
        ...
        <div className="h-[37.5rem] flex flex-col bg-white ">
            <ScrollArea className="relative flex-1 overflow-auto">
                <div aria-hidden="true" className="absolute inset-x-0 z-10 bottom-0 
                h-12 bg-gradient-to-t from-white pointer-events-none"/>

                <div className="px-8 pb-12 pt-8">
                    <h2 className="tracking-tight text-3xl font-bold">Customize your case</h2>
                                        ...
                                        <DropdownMenuContent>
                                            ...
                                            {MODELS.options.map((model) => (
                                                ...
                                                onClick={() => setOptions(prev => ({...prev, model}))}>
                                                    <Check className={cn("mr-2 h-4 w-4", model.label === options.model.label ? "opacity-100" : "opacity-0")}  />                                                  {model.label}
                                    ...
                                    <div className="mt-3 space-y-4">
                                        ...
                                        {selectableOptions.map((option) => (
                                            ...
                                            cn("relative block cursor-pointer rounded-lg bg-white px-6 py-4 shadow-sm border-2 border-zinc-200 focus:outline-none ring-0 focus:ring-0 outline-none sm:flex sm:justify-between",{
                                                ...
                                                <RadioGroup.Description as="span" className="text-gray-500 mt-2 flex text-sm sm:ml-4 
