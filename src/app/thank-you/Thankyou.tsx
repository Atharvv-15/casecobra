        ...
        <div className='bg-white'>
            <div className='mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8'>
                <div className='max-w-xl'>
                    ...
                    <h1 className='mt-2 text-4xl tracking-tight font-bold'>
                ...
                <div>
                    <div className='grid grid-cols-2 gap-x-6 py-10 text-sm justify-between'>
                        <div>
                            ...
                            <div className='mt-2 text-zinc-700'>
                                <address className='not-italic'>
                                    ...
                                    <span className='block'>{shippingAddress?.postalCode}{" "}
                        ...
                        <div>
                            ...
                            <div className='mt-2 text-zinc-700'>
                                <address className='not-italic'>
                                    ...
                                    <span className='block'>{billingAddress?.postalCode}{" "}
                                        {billingAddress?.city}
                                    </span>
                                </address>
                            </div>
